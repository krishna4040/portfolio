  ...
  return (
    ...
    >
      <div>
        ...
        >
          <input
            className="-ml-20 h-10 w-full px-4 py-0 text-lg font-medium shadow-md transition-colors duration-300 lg:m-7 lg:ml-7 lg:w-[1200px] lg:px-8 dark:bg-gray-700 dark:text-white dark:placeholder-gray-300"
            type="text"
